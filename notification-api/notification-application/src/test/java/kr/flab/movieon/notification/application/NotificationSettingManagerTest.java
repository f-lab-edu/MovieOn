...
final class NotificationSettingManagerTest {
    ...
    void sut_disable_the_notificationGroup_in_the_notificationSetting(String accountId) {
        // Arrange
        var settingRepository = new FakeNotificationSettingRepository();
        settingRepository.save(NotificationSetting.defaultSetting(accountId));
        var sut = new NotificationSettingManager(settingRepository);

        // Act
        Throwable result = catchThrowable(
            () -> sut.disable(accountId, "USER_INFO"));
    ...
    void sut_disable_the_notificationOption_in_the_notificationGroup(String accountId) {
        // Arrange
        var settingRepository = new FakeNotificationSettingRepository();
        settingRepository.save(NotificationSetting.defaultSetting(accountId));
        var sut = new NotificationSettingManager(settingRepository);
        ...
        // Act
        Throwable result = catchThrowable(
            () -> sut.disable(accountId, "USER_INFO", "EMAIL"));
    ...
    void sut_enable_the_notificationGroup_in_the_notificationSetting(String accountId) {
        // Arrange
        var settingRepository = new FakeNotificationSettingRepository();
        var setting = NotificationSetting.defaultSetting(accountId);
        ...
        // Act
        Throwable result = catchThrowable(
            () -> sut.enable(accountId, "USER_INFO"));
    ...
    void sut_enable_the_notificationOption_in_the_notificationGroup(String accountId) {
        // Arrange
        var settingRepository = new FakeNotificationSettingRepository();
        var setting = NotificationSetting.defaultSetting(accountId);
        ...
        // Act
        Throwable result = catchThrowable(
            () -> sut.enable(accountId, "USER_INFO", "EMAIL"));
